...
REQUIRED_FILES = [
    ...
    ".github/workflows/validate-agentdefaults.yml",
    ".cursor/rules/agentdefaults.mdc",
    ".windsurfrules",
    "docs/start-here.md",
    "docs/tool-integration-guide.md",
    "docs/quickstarts/codex.md",
    "docs/quickstarts/copilot.md",
    "docs/quickstarts/claude.md",
    "docs/quickstarts/gemini.md",
    "docs/quickstarts/cursor.md",
    "docs/quickstarts/windsurf.md",
    "docs/benchmarks/token-efficiency-smoke-test.md",
    "docs/benchmarks/token-efficiency-fresh-2026-06-25.md",
    "templates/agent-template.md",
    "templates/skill-template.md",
    "templates/prompt-template.md",
    "templates/copilot-agent-template.agent.md",
    "templates/benchmark-artifact-template.md",
    "examples/token-efficient-coding-agent.md",
    "examples/codex-token-benchmark.md",
    "examples/copilot-custom-agent.md",
    "examples/local-llm-prompt-compression.md",
    "examples/agent-handoff-compression.md",
