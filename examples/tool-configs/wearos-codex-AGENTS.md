# AGENTS.md Example: Wear OS Release Work

Copy this into the target app repo as `AGENTS.md`, or merge it into an existing `AGENTS.md`.
...
- Do not modify private release configuration unless the user explicitly asks.
- Mark real-device, Play Console, and production upload items as unverified unless actually checked.
