...
Do not edit the timeline yet. Return the likely intent, best YouTube angle, main points, suggested timeline, clips to cut/demote, and manual review items.
```

## Example 2: Full YouTube First Pass
...
## Example 3: Transcript Cleanup Only
...
## Example 5: AI B-Roll With Approval
