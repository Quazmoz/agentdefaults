...
def _access_payload(error: admob_module.AdMobError, risk: str = "observe") -> dict:
    ...
    return {
        ...
        "detail": str(error),
        "hint": hint,
        "_mra": {"risk": risk, "human_approved": False},
    }
...
def admob_create_app(
    ...
    try:
        ...
        return _access_payload(error, risk)
...
def admob_create_mediation_group(
    ...
    try:
        ...
        return _access_payload(error, "high")
